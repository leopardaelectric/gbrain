...
deterministic, plain mentions excluded by default, deterministic `typed_ner`
relations included only when owned by entity pages, and pure no-op for non-relational queries.
